...
struct CommunityAfterView: View {
    @State var RateModalbool = false
    var body: some View {
        ZStack{
            VStack{
                    ...
                    HStack{
                        ...
                        VStack{
                            Button{
                                ...
                                Text("Rate").padding(.horizontal,10).padding(.vertical,5).background(.blue).foregroundColor(.white).cornerRadius(20).sheet(isPresented: $RateModalbool){RateModal()}
                            }
                        }.padding(.top,-10)
                    }.padding(.trailing, 20)
                }
                    ...
                    VStack{
                        HStack{
                            ...
                            NavigationLink(destination: DiscussionView()){
                                Text("Show More").padding(.trailing,30)
                            }
                        }
                        Rectangle().frame(width: 315.0, height: 2.0)
                        VStack{
...
struct CommunityAfterView_Previews: PreviewProvider {
